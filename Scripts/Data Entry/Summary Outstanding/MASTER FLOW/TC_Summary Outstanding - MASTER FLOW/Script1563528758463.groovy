...
not_run: Mobile.waitForElementAttributeValue(findTestObject('Summary Outstanding/SummaryOutstanding_Survey_BtnConfirm'), 
    'clickable', 'false', 240, FailureHandling.OPTIONAL)
