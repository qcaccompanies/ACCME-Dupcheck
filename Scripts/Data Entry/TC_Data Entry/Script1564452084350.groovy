...
WebUI.callTestCase(findTestCase('Data Entry/Simulasi Kredit/Simulasi Kredit - Asuransi/MASTER FLOW/TC_Asuransi - MASTER FLOW'), 
    [('varAsuransi') : varAsuransi, ('varKodeWilayah') : varKodeWilayah], FailureHandling.OPTIONAL)

WebUI.callTestCase(findTestCase('Data Entry/Simulasi Kredit/Kategori Loan/MASTER FLOW/TC_Kategori Loan - Master FLOW'), 
    [('varOpsiNPWP') : varOpsiNPWP], FailureHandling.OPTIONAL)
...
WebUI.callTestCase(findTestCase('Data Entry/Borrower/Flow Borrower'), [('BIvarNoKTP') : BIvarNoKTP, ('BIvarAgama') : BIvarAgama
        ...
        , ('BIvarTempatLahir') : BIvarTempatLahir, ('BIvarNama') : BIvarNama], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Data Entry/Co-Borrower/Flow Coborrower'), [('CvarPekerjaanTab') : 'Ya', ('CvarUsahaTab') : 'Ya'
        ...
        , ('CIUvarHP') : '089627266744', ('CIUvarJenisAkunSosmed') : 'INSTAGRAM', ('CIUvarAkunSosmed') : '@tharamcy', ('CDvarAlamatLengkap') : 'jl wahyu 1 no 18 jakarta selatan'
        ...
        , ('CPvarWebsite') : 'dokterku.com', ('CPvarJenisAkunSosmed') : 'INSTAGRAM', ('CPvarAkunSosmed') : '@dokterku', ('CPvarAlamatKantor') : 'jl rs fatmawati no 9 jakarta selatan'
        , ('CPvarRT') : '11', ('CPvarRW') : '11', ('CPvarKodePos') : '12420', ('CPvarPetunjukAlamat') : 'seberang pasar\r\n'
        , ('CPvarNoTlp1') : '021', ('CPvarNoTlp2') : '98727', ('CPvarNoExt') : '655', ('CUvarPekerjaan') : 'PENGUSAHA', ('CUvarBadanUsaha') : 'CV'
        , ('CUvarNamaPerusahaan') : 'ASURANSIBULAN', ('CUvarBidangUsaha') : 'ASURANSI', ('CUvarSubBidangUsaha') : 'ASURANSI DAN DANA PENSIUN'
        ...
        , ('CUvarHP') : '089725526722', ('CUvarWebsite') : 'asurnsibulan.com', ('CUvarAkunsosmed') : '@ASURANSIBULAN', ('CUvarJenisSosmed') : 'INSTAGRAM'], 
    FailureHandling.STOP_ON_FAILURE)
